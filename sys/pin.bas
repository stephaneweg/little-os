...
sub Main(p as any ptr) 
    ...
    var b1 = ButtonCreate(panel,0*buttonWidth,(panelHeight-buttonHeight) shr 1,buttonWidth,buttonHeight,@"Applications",@btnClick,1)
    var b2 = ButtonCreate(panel,1*buttonWidth,(panelHeight-buttonHeight) shr 1,buttonWidth,buttonHeight,@"Settings",@btnClick,2)
    var b3 = ButtonCreate(panel,2*buttonWidth,(panelHeight-buttonHeight) shr 1,buttonWidth,buttonHeight,@"Documents",@btnClick,3)
    var b4 = ButtonCreate(panel,3*buttonWidth,0,panelHeight,panelHeight,@"",@btnCollapseClick,4)
    ButtonSetSkin(b1,@"SYS:/RES/PINBTN1.BMP")
    ButtonSetIcon(b1,@"SYS:/ICONS/APPS2.BMP",0)
    
    ButtonSetSkin(b2,@"SYS:/RES/PINBTN1.BMP")
    ButtonSetIcon(b2,@"SYS:/ICONS/CONTROL.BMP",0)
    
    ButtonSetSkin(b3,@"SYS:/RES/PINBTN1.BMP")
    ButtonSetIcon(b3,@"SYS:/ICONS/DOCS2.BMP",0)
    
    ButtonSetSkin(b4,@"SYS:/RES/STRIP.BMP")
